...
@section('title', 'Edit Merchant Review')
@section('page-header', 'Edit Merchant Review')
...
<div class="container-fluid p-0">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold text-dark mb-1 font-cinzel">
                <i class="bi bi-pencil-square text-primary me-2"></i> Edit Review: {{ $review->client_name }}
            </h4>
            <p class="text-muted small mb-0">Update merchant feedback, rating, location, or publication status.</p>
        </div>
    ...
    <form action="{{ route('admin.reviews.update', $review) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text" style="font-size: 11px;">Preserve genuine feedback as received from the merchant.</div>
                    ...
                    <div class="mb-2">
                            ...
                            <div class="star-rating d-flex gap-1" id="starRating">
                                @for($i = 1; $i <= 5; $i++)
                                    <label class="cursor-pointer" title="{{ $i }} star{{ $i > 1 ? 's' : '' }}" style="cursor: pointer;">
                                        <input type="radio" name="rating" value="{{ $i }}" class="d-none star-radio" {{ old('rating', $review->rating) == $i ? 'checked' : '' }}>
                                        <i class="bi bi-star{{ old('rating', $review->rating) >= $i ? '-fill' : '' }} fs-4 {{ old('rating', $review->rating) >= $i ? 'text-warning' : 'text-muted' }} star-icon" data-star="{{ $i }}"></i>
                                    </label>
                                @endfor
                            </div>
                            <div>
                        ...
                        <div class="form-text" style="font-size: 11px;">Leave clear if no explicit rating was given.</div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text" style="font-size: 11px;">Optional to protect merchant identity.</div>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('location', $review->location) }}" 
                               required>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('display_order', $review->display_order) }}" 
                               min="0" 
                               required>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-3 bg-light text-center">
                    <button type="submit" class="btn btn-gold w-100 py-2 fw-bold">
                        <i class="bi bi-check-circle-fill me-1"></i> Update Review
                    </button>
